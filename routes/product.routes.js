...
const productControllers=require(path.join(__dirname,"../controllers/product.controllers"));
const {authJWT,requestValidator}=require(path.join(__dirname,"../middleware"));
